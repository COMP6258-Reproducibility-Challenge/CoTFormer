...
TRAIN_ARGS=(
    ...
    --exp_name "BUT_constructive_phop_${TASK}_BUT_${N_LAYER}layer_${N_REPEAT}repeat_d${N_EMBD}_h${N_HEAD}_bs${BATCH_SIZE}x${ACC_STEPS}_seed${SEED}"
    --use_pretrained auto
    --phop_task "$TASK"
...
echo "   bash iridis/p-hop-but-train/job.sh"
echo ""
