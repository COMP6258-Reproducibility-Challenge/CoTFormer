#!/bin/bash
#SBATCH --job-name=flash_tr_caus_eval_test_run
...
CKPT_FREQ=50    # Save every 2000 steps
...
echo " Model:         flash_train_caus_eval"
...
EXPNAME="f_train_caus_eval_test_run_two_gpus_low_cpu_ram"
export WANDB_MODE=offline
export WANDB_RESUME="allow"
export WANDB_RUN_ID="RUN_40k_${EXPNAME}"
export WANDB_NAME="f_train_caus_eval_test_runlow_cpu_ram"
