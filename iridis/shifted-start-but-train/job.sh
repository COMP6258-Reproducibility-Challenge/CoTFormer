...
#
# Usage:
#   cd ~/CoTFormer && bash iridis/shifted-start-but-train/job.sh
#
# Requires:
...
TRAIN_ARGS=(
    ...
    --exp_name "shifted_start_${TASK}_but_full_depth_${N_LAYER}layer_${N_REPEAT}repeat_bs${BATCH_SIZE}x${ACC_STEPS}_seqlen256"
    --use_pretrained auto
    --ib_task "$TASK"
...
echo "   bash iridis/shifted-start-but-train/job.sh"
echo ""
